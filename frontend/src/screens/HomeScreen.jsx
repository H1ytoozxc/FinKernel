...
const s = {
  ...
  portfolioValue: { fontSize: 32, fontWeight: 800, color: "var(--text-primary)", marginBottom: 4 },
  portfolioValueMobile: { fontSize: 28 },
  portfolioPnl: { fontSize: 15, fontWeight: 600 },
  chartCard: {
    background: "var(--card-bg)", borderRadius: 16, padding: "24px 28px", marginBottom: 20,
  ...
  lessonTitle: { fontSize: 18, fontWeight: 700, color: "var(--text-primary)", marginBottom: 4 },
  ...
  statCard: {
    background: "var(--card-bg)", borderRadius: 12, padding: "16px 12px",
